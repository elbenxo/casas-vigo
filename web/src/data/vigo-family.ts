    ...
    places: [
      {
        ...
        free: true,
        tip: {
          es: 'Buen sitio para merendar al atardecer.',
          en: 'A great spot for a snack at sunset.',
          gl: 'Bo sitio para merendar ao solpor.',
          fr: 'Un bel endroit pour un goûter au coucher du soleil.',
          de: 'Ein toller Ort für eine Jause bei Sonnenuntergang.',
          ko: '해질녘 간식을 즐기기 좋은 곳입니다.',
          pt: 'Um ótimo sítio para um lanche ao pôr do sol.',
          pl: 'Świetne miejsce na przekąskę o zachodzie słońca.',
        },
      },
      {
