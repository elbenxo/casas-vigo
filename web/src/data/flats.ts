// AUTO-GENERATED by scripts/sync-web.js — DO NOT EDIT BY HAND
// Source of truth: SQLite (data/casasvigo.db) + photos + reviews
// To update: edit via dashboard, then run preview-web.js → publish
...
export const flats: Flat[] = [
  {
    slug: "irmandinhos",
    name: { es: "Piso Rúa Irmandiños", en: "Rúa Irmandiños Flat", gl: "Piso Rúa Irmandiños", fr: "Appartement Rúa Irmandiños", de: "Wohnung Rúa Irmandiños", ko: "Rúa Irmandiños 아파트", pt: "Apartamento Rúa Irmandiños", pl: "Mieszkanie Rúa Irmandiños" },
    ...
    description: { es: "Espectacular piso reformado a estrenar en una de las mejores calles de Vigo. Amplias habitaciones con luz natural todo el día, acabados de primera calidad y una distribución perfecta para compartir. Zona tranquila y residencial pero a cinco minutos andando del centro y de todos los servicios. Sin duda, nuestra joya.", en: "Spectacular newly renovated flat on one of the best streets in Vigo. Spacious rooms with natural light all day, top-quality finishes, and a perfect layout for sharing. A quiet residential area just five minutes on foot from the city center and all amenities. Without a doubt, our crown jewel.", gl: "Espectacular piso reformado a estrear nunha das mellores rúas de Vigo. Amplas habitacións con luz natural todo o día, acabados de primeira calidade e unha distribución perfecta para compartir. Zona tranquila e residencial pero a cinco minutos andando do centro e de todos os servizos. Sen dúbida, a nosa xoia.", fr: "Spectaculaire appartement rénové à étrenner dans l'une des meilleures rues de Vigo. Chambres spacieuses avec lumière naturelle toute la journée, finitions de première qualité et une distribution parfaite pour la colocation. Quartier calme et résidentiel mais à cinq minutes à pied du centre et de tous les services. Sans aucun doute, notre joyau.", de: "Spektakuläre neu renovierte Wohnung in einer der besten Straßen von Vigo. Geräumige Zimmer mit Tageslicht den ganzen Tag, erstklassige Ausstattung und eine perfekte Aufteilung zum Teilen. Ruhige Wohngegend, nur fünf Gehminuten vom Zentrum und allen Einrichtungen entfernt. Zweifellos unser Juwel.", ko: "비고 최고의 거리 중 하나에 위치한 새로 리노베이션한 멋진 아파트입니다. 하루 종일 자연광이 들어오는 넓은 방, 최고급 마감재, 공유에 완벽한 구조. 조용한 주거 지역이지만 도심과 모든 편의시설까지 도보 5분. 의심할 여지 없이 우리의 보석입니다.", pt: "Espetacular apartamento renovado a estrear numa das melhores ruas de Vigo. Quartos espaçosos com luz natural o dia todo, acabamentos de primeira qualidade e uma distribuição perfeita para partilhar. Zona tranquila e residencial mas a cinco minutos a pé do centro e de todos os serviços. Sem dúvida, a nossa jóia.", pl: "Spektakularnie odnowione mieszkanie na jednej z najlepszych ulic Vigo. Przestronne pokoje z naturalnym światłem przez cały dzień, wykończenie najwyższej jakości i idealny układ do współdzielenia. Spokojna dzielnica mieszkaniowa, zaledwie pięć minut pieszo od centrum i wszystkich udogodnień. Bez wątpienia nasza perła." },
    image: `${IMG}/irmandinhos/bano.jpg`,
    images: [
    ...
    rooms: [
      {
        ...
        features: ["Escritorio", "armario empotrado", "lampara arana"],
        images: [
          `${IMG}/irmandinhos/hab-primavera-1.jpg`,
          `${IMG}/irmandinhos/hab-primavera-2.jpg`
        ],
      },
      {
        id: "ir-verano",
        ...
        features: ["Escritorio", "armario empotrado"],
        images: [
          `${IMG}/irmandinhos/hab-verano-1.jpg`,
          `${IMG}/irmandinhos/hab-verano-2.jpg`
        ],
      },
      {
        id: "ir-otono",
        ...
        images: [
          ...
          `${IMG}/irmandinhos/hab-otono-2.jpg`
        ],
      },
      {
        id: "ir-invierno",
        ...
        features: ["Escritorio", "armario empotrado"],
        images: [
          `${IMG}/irmandinhos/hab-invierno-1.jpg`
        ],
      },
    ],
  ...
  },
  {
    ...
    name: { es: "Piso Alfonso XIII – 1º Derecha", en: "Alfonso XIII Flat – 1st Right", gl: "Piso Alfonso XIII – 1º Dereita", fr: "Appartement Alfonso XIII – 1er Droite", de: "Wohnung Alfonso XIII – 1. Rechts", ko: "Alfonso XIII 아파트 – 1층 오른쪽", pt: "Apartamento Alfonso XIII – 1º Direita", pl: "Mieszkanie Alfonso XIII – 1. Prawe" },
    ...
    description: { es: "Amplio piso de seis habitaciones en primera planta con galería acristalada y vistas a la ciudad. Decoración temática única en cada habitación, dos baños completos, salón luminoso y patio privado. A un paso de la estación de alta velocidad y de la estación de autobuses.", en: "Spacious six-bedroom first-floor flat with a glazed gallery and city views. Each room features unique themed décor, two full bathrooms, a bright living room, and a private courtyard. Steps from the high-speed train station and the city center.", gl: "Amplo piso de seis habitacións na primeira planta con galería acristalada e vistas á cidade. Decoración temática única en cada habitación, dous baños completos, salón luminoso e patio privado. A un paso da estación de alta velocidade e do centro.", fr: "Spacieux appartement de six chambres au premier étage avec galerie vitrée et vues sur la ville. Décoration thématique unique dans chaque chambre, deux salles de bains complètes, salon lumineux et cour privée. À deux pas de la gare à grande vitesse et du centre-ville.", de: "Geräumige Sechs-Zimmer-Wohnung im ersten Stock mit verglaster Galerie und Blick auf die Stadt. Jedes Zimmer hat ein einzigartiges Themendekor, zwei vollständige Badezimmer, ein helles Wohnzimmer und einen privaten Innenhof. Nur wenige Schritte vom Hochgeschwindigkeitsbahnhof und dem Stadtzentrum entfernt.", ko: "유리 갤러리와 도시 전망을 갖춘 1층 6실 넓은 아파트입니다. 각 방마다 독특한 테마 인테리어, 화장실 2개, 밝은 거실, 개인 안뜰을 갖추고 있습니다. 고속철도역과 도심에서 도보 거리입니다.", pt: "Amplo apartamento de seis quartos no primeiro andar com galeria envidraçada e vistas para a cidade. Decoração temática única em cada quarto, duas casas de banho completas, sala luminosa e pátio privado. A um passo da estação de alta velocidade e do centro.", pl: "Przestronne sześciopokojowe mieszkanie na pierwszym piętrze z przeszklonym balkonem i widokiem na miasto. Unikalna dekoracja tematyczna w każdym pokoju, dwie łazienki, jasny salon i prywatne patio. Kilka kroków od dworca szybkiej kolei i centrum miasta." },
    image: `${IMG}/1-derecha/bano-cascada.jpg`,
    images: [
      `${IMG}/1-derecha/bano-cascada.jpg`,
      `${IMG}/1-derecha/bano-grande-2.jpg`,
      `${IMG}/1-derecha/bano-grande.jpg`,
      `${IMG}/1-derecha/cocina-ventana.jpg`,
    ...
    rooms: [
      ...
      },
      {
        ...
        features: ["Escritorio", "armario", "estanteria"],
        images: [
          `${IMG}/1-derecha/hab-bambu.jpg`
        ],
      },
      {
        id: "1d-estrella",
        ...
        features: ["Escritorio", "armario empotrado"],
        images: [
          `${IMG}/1-derecha/hab-estrella.jpg`
        ],
      },
      {
        id: "1d-mundo",
        ...
        features: ["Escritorio", "armario empotrado", "mural decorativo"],
        images: [
          `${IMG}/1-derecha/hab-mundo.jpg`
        ],
      },
      {
        id: "1d-arroba",
        ...
        features: ["Escritorio", "armario", "papel pintado tematico"],
        images: [
          `${IMG}/1-derecha/hab-arroba.jpg`
        ],
      },
      {
        id: "1d-prensa",
        ...
        features: ["Escritorio", "armario", "separador de ambientes"],
        images: [
          `${IMG}/1-derecha/hab-prensa.jpg`
        ],
      },
    ],
  ...
  },
  {
    ...
    name: { es: "Piso Alfonso XIII – 3º Izquierda", en: "Alfonso XIII Flat – 3rd Left", gl: "Piso Alfonso XIII – 3º Esquerda", fr: "Appartement Alfonso XIII – 3e Gauche", de: "Wohnung Alfonso XIII – 3. Links", ko: "Alfonso XIII 아파트 – 3층 왼쪽", pt: "Apartamento Alfonso XIII – 3º Esquerda", pl: "Mieszkanie Alfonso XIII – 3. Lewe" },
    address: "Alfonso XIII 9, Vigo",
    neighborhood: { es: "Estación AVE y autobuses", en: "AVE & Bus Stations", gl: "Estación AVE e autobuses", fr: "Gares AVE et routière", de: "AVE- & Busbahnhof", ko: "고속철도 및 버스터미널", pt: "Estação AVE e autocarros", pl: "Dworzec AVE i autobusowy" },
    description: { es: "Piso señorial de seis habitaciones en tercera planta con salón con chimenea de mármol y vistas panorámicas a la ría de Vigo. Reformado con baño nuevo en 2025. Habitaciones amplias con decoración por colores, comedor para ocho personas y cocina equipada.", en: "Stately six-bedroom flat on the third floor with a marble fireplace lounge and panoramic views of the Vigo estuary. Renovated with a new bathroom in 2025. Spacious color-themed rooms, an eight-seat dining room, and a fully equipped kitchen.", gl: "Piso señorial de seis habitacións na terceira planta con salón con cheminea de mármore e vistas panorámicas á ría de Vigo. Reformado con baño novo en 2025. Habitacións amplas con decoración por cores, comedor para oito persoas e cociña equipada.", fr: "Appartement majestueux de six chambres au troisième étage avec salon avec cheminée en marbre et vues panoramiques sur la ria de Vigo. Rénové avec nouvelle salle de bains en 2025. Chambres spacieuses décorées par couleurs, salle à manger pour huit personnes et cuisine équipée.", de: "Herrschaftliche Sechs-Zimmer-Wohnung im dritten Stock mit Wohnzimmer mit Marmorkamin und Panoramablick auf die Bucht von Vigo. 2025 mit neuem Badezimmer renoviert. Geräumige farblich gestaltete Zimmer, Esszimmer für acht Personen und voll ausgestattete Küche.", ko: "대리석 벽난로 라운지와 비고 하구의 파노라마 전망을 갖춘 3층 6실 격조 높은 아파트입니다. 2025년 새 욕실로 리노베이션. 색상별 테마의 넓은 방, 8인용 식당, 완비된 주방을 갖추고 있습니다.", pt: "Apartamento senhorial de seis quartos no terceiro andar com sala com lareira de mármore e vistas panorâmicas para a ria de Vigo. Renovado com nova casa de banho em 2025. Quartos espaçosos decorados por cores, sala de jantar para oito pessoas e cozinha equipada.", pl: "Dostojne sześciopokojowe mieszkanie na trzecim piętrze z salonem z marmurowym kominkiem i panoramicznym widokiem na zatokę Vigo. Odnowione z nową łazienką w 2025 roku. Przestronne pokoje dekorowane kolorami, jadalnia na osiem osób i wyposażona kuchnia." },
    image: `${IMG}/3-izquierda/bano.jpg`,
    images: [
    ...
    rooms: [
      {
        ...
        features: ["Escritorio", "armario empotrado"],
        images: [
          `${IMG}/3-izquierda/hab-azul-1.jpg`,
          `${IMG}/3-izquierda/hab-azul-2.jpg`
        ],
      },
      {
        id: "3i-roja",
        ...
        features: ["Armario empotrado"],
        images: [
          `${IMG}/3-izquierda/hab-roja.jpg`
        ],
      },
      {
        id: "3i-amarilla",
      ...
      },
      {
        ...
        features: ["Escritorio grande", "armario empotrado"],
        images: [
          `${IMG}/3-izquierda/hab-verde-escritorio.jpg`,
          `${IMG}/3-izquierda/hab-verde.jpg`
        ],
      },
      {
        id: "3i-blanca",
        ...
        features: ["Panel cristal al baño", "armario empotrado"],
        images: [
          `${IMG}/3-izquierda/hab-blanca-2.jpg`,
          `${IMG}/3-izquierda/hab-blanca.jpg`
        ],
      },
      {
        id: "3i-gris",
        ...
        price: 310, available: true, size: "11m²",
        features: ["Estanteria", "armario"],
        images: [
          `${IMG}/3-izquierda/hab-gris-2.jpg`,
          `${IMG}/3-izquierda/hab-gris.jpg`
        ],
      },
    ],
  ...
  },
  {
    ...
    name: { es: "Ático Alfonso XIII – 4º Derecha", en: "Alfonso XIII Penthouse – 4th Right", gl: "Ático Alfonso XIII – 4º Dereita", fr: "Penthouse Alfonso XIII – 4e Droite", de: "Penthouse Alfonso XIII – 4. Rechts", ko: "Alfonso XIII 펜트하우스 – 4층 오른쪽", pt: "Sótão Alfonso XIII – 4º Direita", pl: "Penthouse Alfonso XIII – 4. Prawe" },
    address: "Alfonso XIII 9, Vigo",
    neighborhood: { es: "Estación AVE y autobuses", en: "AVE & Bus Stations", gl: "Estación AVE e autobuses", fr: "Gares AVE et routière", de: "AVE- & Busbahnhof", ko: "고속철도 및 버스터미널", pt: "Estação AVE e autocarros", pl: "Dworzec AVE i autobusowy" },
    description: { es: "Ático único con vistas panorámicas espectaculares de Vigo, la ría y las montañas. Cinco habitaciones con personalidad propia, techos abuhardillados con encanto, dos baños modernos y cocina totalmente equipada. Desde el balcón se disfruta de uno de los mejores miradores de la ciudad.", en: "Unique penthouse with spectacular panoramic views of Vigo, the estuary, and the mountains. Five bedrooms with distinct personalities, charming sloped ceilings, two modern bathrooms, and a fully equipped kitchen. The balcony offers one of the best viewpoints in the city.", gl: "Ático único con vistas panorámicas espectaculares de Vigo, a ría e as montañas. Cinco habitacións con personalidade propia, teitos abufardillados con encanto, dous baños modernos e cociña totalmente equipada. Desde o balcón gózase dun dos mellores miradoiros da cidade.", fr: "Penthouse unique avec des vues panoramiques spectaculaires sur Vigo, la ria et les montagnes. Cinq chambres avec leur propre personnalité, charmants plafonds mansardés, deux salles de bains modernes et cuisine entièrement équipée. Le balcon offre l'un des meilleurs points de vue de la ville.", de: "Einzigartiges Penthouse mit spektakulärem Panoramablick auf Vigo, die Bucht und die Berge. Fünf Schlafzimmer mit eigenem Charakter, charmante Dachschrägen, zwei moderne Badezimmer und eine voll ausgestattete Küche. Der Balkon bietet einen der besten Aussichtspunkte der Stadt.", ko: "비고, 하구, 산의 장엄한 파노라마 전망을 자랑하는 유니크한 펜트하우스입니다. 개성 있는 5개의 침실, 매력적인 경사 천장, 모던한 욕실 2개, 완비된 주방을 갖추고 있습니다. 발코니에서 도시 최고의 전망을 즐길 수 있습니다.", pt: "Sótão único com vistas panorâmicas espetaculares de Vigo, a ria e as montanhas. Cinco quartos com personalidade própria, encantadores tetos mansardados, duas casas de banho modernas e cozinha totalmente equipada. A varanda oferece um dos melhores miradouros da cidade.", pl: "Wyjątkowy penthouse ze spektakularnym panoramicznym widokiem na Vigo, zatokę i góry. Pięć sypialni o własnym charakterze, urokliwe skośne sufity, dwie nowoczesne łazienki i w pełni wyposażona kuchnia. Balkon oferuje jeden z najlepszych punktów widokowych w mieście." },
    image: `${IMG}/4-derecha-atico/bano-1.jpg`,
    images: [
    ...
    rooms: [
      {
        ...
        price: 370, available: true, size: "13m²",
        features: ["Viga vista", "canapé", "armario"],
        images: [
          `${IMG}/4-derecha-atico/hab-oliva.jpg`
        ],
      },
      {
        id: "4d-blancoynegro",
        ...
        price: 350, available: true, size: "12m²",
        features: ["Techo abuhardillado", "escritorio"],
        images: [
          `${IMG}/4-derecha-atico/hab-blanco-negro.jpg`
        ],
      },
      {
        id: "4d-pistacho",
        ...
        price: 340, available: true, size: "11m²",
        features: ["Armario empotrado", "escritorio"],
        images: [
          `${IMG}/4-derecha-atico/hab-pistacho.jpg`
        ],
      },
      {
        id: "4d-roja",
        ...
        features: ["Escritorio", "armario"],
        images: [
          `${IMG}/4-derecha-atico/hab-roja-escritorio.jpg`,
          `${IMG}/4-derecha-atico/hab-roja.jpg`
        ],
      },
      {
        id: "4d-calabaza",
        ...
        features: ["Claraboya", "escritorio", "armario empotrado"],
        images: [
          `${IMG}/4-derecha-atico/hab-calabaza.jpg`
        ],
      },
    ],
  ...
  },
  {
    ...
    wholeFlatPrice: 1300,
    name: { es: "Ático Alfonso XIII – 4º Izquierda", en: "Alfonso XIII Penthouse – 4th Left", gl: "Ático Alfonso XIII – 4º Esquerda", fr: "Penthouse Alfonso XIII – 4e Gauche", de: "Penthouse Alfonso XIII – 4. Links", ko: "Alfonso XIII 펜트하우스 – 4층 왼쪽", pt: "Sótão Alfonso XIII – 4º Esquerda", pl: "Penthouse Alfonso XIII – 4. Lewe" },
    address: "Alfonso XIII 9, Vigo",
    neighborhood: { es: "Estación AVE y autobuses", en: "AVE & Bus Stations", gl: "Estación AVE e autobuses", fr: "Gares AVE et routière", de: "AVE- & Busbahnhof", ko: "고속철도 및 버스터미널", pt: "Estação AVE e autocarros", pl: "Dworzec AVE i autobusowy" },
    description: { es: "Espectacular ático abuhardillado con enormes ventanales de suelo a techo y vistas a la ría de Vigo. Salón-comedor diáfano con cocina americana, terraza privada, dos habitaciones con decoración única y baño moderno. La joya de la corona del edificio.", en: "Spectacular attic penthouse with huge floor-to-ceiling windows and views of the Vigo estuary. Open-plan living-dining room with an American kitchen, private terrace, two uniquely decorated bedrooms, and a modern bathroom. The crown jewel of the building.", gl: "Espectacular ático abufardillado con enormes ventanais de chan a teito e vistas á ría de Vigo. Salón-comedor diáfano con cociña americana, terraza privada, dúas habitacións con decoración única e baño moderno. A xoia da coroa do edificio.", fr: "Spectaculaire penthouse mansardé avec d'immenses baies vitrées du sol au plafond et vues sur la ria de Vigo. Salon-salle à manger décloisonné avec cuisine américaine, terrasse privée, deux chambres à décoration unique et salle de bains moderne. Le joyau de la couronne de l'immeuble.", de: "Spektakuläres Dachgeschoss-Penthouse mit riesigen bodentiefen Fenstern und Blick auf die Bucht von Vigo. Offener Wohn-Essbereich mit amerikanischer Küche, private Terrasse, zwei einzigartig dekorierte Schlafzimmer und ein modernes Badezimmer. Das Kronjuwel des Gebäudes.", ko: "바닥부터 천장까지 거대한 창문과 비고 하구 전망을 자랑하는 멋진 다락방 펜트하우스입니다. 아메리칸 키친이 있는 오픈 리빙-다이닝, 프라이빗 테라스, 유니크한 인테리어의 침실 2개, 모던한 욕실을 갖추고 있습니다. 건물의 최고 보석입니다.", pt: "Espetacular sótão mansardado com enormes janelas do chão ao teto e vistas para a ria de Vigo. Sala-sala de jantar aberta com cozinha americana, terraço privado, dois quartos com decoração única e casa de banho moderna. A jóia da coroa do edifício.", pl: "Spektakularny poddasze-penthouse z ogromnymi oknami od podłogi do sufitu i widokiem na zatokę Vigo. Otwarty salon z aneksem kuchennym w stylu amerykańskim, prywatny taras, dwie unikatowo udekorowane sypialnie i nowoczesna łazienka. Klejnot koronny budynku." },
    image: `${IMG}/4-izquierda-atico/bano.jpg`,
    images: [
    ...
    rooms: [
      {
        ...
        features: ["Escritorio", "armario empotrado", "lampara arana", "decoracion provenzal"],
        images: [
      ...
      },
      {
        ...
        features: ["Escritorio cristal", "armario", "decoracion urbana"],
        images: [
