...
- **Owner**: Benxamin Porto, phone `OWNER_PHONE`
...
.claude/skills/elbenxo-bot/
  ...
  references/
    ...
    contacts/
      ...
      benxamin.md                   # Contact profile: Benxamin (OWNER_PHONE) - self/testing
  scripts/
...
| Benxamin | OWNER_PHONE | OWNER_PHONE@c.us | Enabled (testing) |
